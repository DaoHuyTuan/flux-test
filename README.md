...
| [`src/command/`](./src/command/) | CLEANSE command -- stub file where your implementation goes. |
...
| `src/command/CLEANSE.ts` | Reducer core (command and composition are provided) |
| `src/command/CLEANSE.spec.ts` | Tests for the reducer (starter tests provided; add your own) |
